...
2. Hard reload: clear CacheStorage and service-worker registrations through the storage cleanup evaluation, then `reload`; do not preserve a browser cache or inline dev core as proof.
