...
The runtime config is a TOML file loaded with `gg-runtime-server --config <path>`. The complete example lives at [`examples/runtime-server.toml`](https://github.com/amxv/gooselake/blob/main/examples/runtime-server.toml).
