...
- OpenAPI generator: [`crates/runtime-server/src/openapi.rs`](../crates/runtime-server/src/openapi.rs)
- shared runtime structs: [`crates/runtime-core/src`](../crates/runtime-core/src)
...
See [Endpoint Catalog](./API_ENDPOINTS.md) for the full route list.
...
See [Provider Guide](./PROVIDERS.md) for full provider setup.
...
See [MCP and Sidecars](./MCP_AND_SIDECARS.md) for sidecar details.
